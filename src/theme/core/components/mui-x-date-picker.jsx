...
import { inputStyles, inputBaseStyles, filledInputStyles, outlinedInputStyles } from './text-field';
...
const inputComponents = {
  ...
  MuiPickersInput: {
    styleOverrides: {
      root: ({ theme }) => inputStyles.underline(theme),
    },
  },
...
const datePickerComponents = {
  ...
  MuiDesktopDatePicker: {
    defaultProps: { slots: { ...defaultProps.dateSlots } },
  },
  MuiMobileDatePicker: {
    defaultProps: { slots: { ...defaultProps.dateSlots } },
  },
...
const timePickerComponents = {
  ...
  MuiDesktopTimePicker: {
    defaultProps: { slots: { ...defaultProps.timeSlots } },
  },
  MuiMobileTimePicker: {
    defaultProps: { slots: { ...defaultProps.timeSlots } },
  },
